// STUB — replace with the full implementation of `guilloche-intaglio-plate` (docs/svg-feature-demos.md §3).
import { el, mark, FONT_SERIF } from './lib';

export function render(stage: SVGSVGElement): void {
  stage.append(el('title', {}, 'guilloche-intaglio-plate (stub)'));
  ...
  stage.append(el('text', { x: 700, y: 200, 'text-anchor': 'middle', 'font-family': FONT_SERIF, 'font-size': 40, fill: '#f0d9a0' }, 'guilloche-intaglio-plate'));
